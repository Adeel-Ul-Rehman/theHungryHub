...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const navItems = [
    ...
    { label: 'AI Analysis', icon: Bot, path: '/ai-assistant', badge: 'AI' },
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <aside
        className={`fixed md:sticky top-0 left-0 z-40 w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col justify-between h-screen transition-transform duration-300 ${
          ...
          <div className="p-5 flex items-center justify-between border-b border-slate-100 dark:border-slate-800/80">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-semibold text-orange-600 dark:text-orange-400">Web Admin & AI Portal</p>
              </div>
            </div>
        ...
        <div className="p-4 border-t border-slate-100 dark:border-slate-800/80 space-y-3">
          ...
          <div className="flex items-center justify-between p-3 rounded-xl bg-slate-50 dark:bg-slate-800/40">
            <div className="flex items-center gap-2.5 truncate">
              {admin.avatarUrl ? (
                <img src={admin.avatarUrl} alt="Avatar" className="w-8 h-8 rounded-full object-cover shrink-0" />
              ) : (
